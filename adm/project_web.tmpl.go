...
> make serve</pre>
                            ...
                            <ul>
                                <li>
                                    <span style="font-size:15px;font-weight:normal;">Github：&nbsp;<a
                                                href="https://github.com/MarErm27/go-admin" target="_blank">https://github.com/MarErm27/go-admin</a></span>
                                </li>
                                <li>
                    ...
                    <div class="ui attached segment install-success-readme-en"
                        ...
                        <ul>
                            <li>
                                <a href="https://raw.githubusercontent.com/MarErm27/go-admin/master/data/admin.sql"
                                   target="_blank">Mysql</a>
                            </li>
                            <li>
                                <a href="https://raw.githubusercontent.com/MarErm27/go-admin/master/data/admin.mssql"
                                   target="_blank">Mssql</a>
                            </li>
                            <li>
                                <a href="https://raw.githubusercontent.com/MarErm27/go-admin/master/data/admin.pgsql"
                                   target="_blank">Postgresql</a>
                            </li>
                            <li>
                                <a href="https://raw.githubusercontent.com/MarErm27/go-admin/master/data/admin.db"
