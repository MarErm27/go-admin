...
* Translations
    * README.md
    * [docs](https://github.com/MarErm27/docs/issues/1)
* Bug-hunting
* Finding security problems
* Themes and Plugins

See [manual](https://github.com/MarErm27/go-admin/projects/3) for more information.
...
For now, you need to add your fork as a remote on the original **\$GOPATH**/src/github.com/MarErm27/go-admin clone, so:

```bash

$ go get github.com/MarErm27/go-admin
$ cd $GOPATH/src/github.com/MarErm27/go-admin # GOPATH is $HOME/go by default.
...
Notice: `go get` return `package github.com/MarErm27/go-admin: no Go files in /go/src/github.com/MarErm27/go-admin` is normal.
...
* [Tasks](https://github.com/MarErm27/go-admin/projects)
